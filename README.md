...
*Quant DSL* has been tested with Python 2.7 on GNU/Linux (Ubuntu 14.04) and on Windows 7 (using PythonXY v2.7.6.1).
...
```
$ quant-dsl.py -h
usage: quant-dsl.py [-h] [-q] [-c CALIBRATION] [-n NUM_PATHS]
